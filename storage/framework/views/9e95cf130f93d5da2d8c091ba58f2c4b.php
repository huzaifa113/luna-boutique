<footer class="mt-20 border-t border-slate-200/70 bg-slate-50 py-12">
    <div class="site-container space-y-12">
        <div class="grid gap-10 md:grid-cols-[1.25fr_0.75fr_0.75fr_1.1fr]">
            ...
            <div>
                ...
                <ul class="mt-6 space-y-3 text-slate-700">
                    <li><a href="<?php echo e(route('shop.index')); ?>" class="transition hover:text-indigo-600">All Products</a></li>
                    <li><a href="<?php echo e(route('categories.show', ['category' => 'women'])); ?>"
                            class="transition hover:text-indigo-600">Women</a></li>
                    <li><a href="<?php echo e(route('categories.show', ['category' => 'men'])); ?>"
            ...
            <div>
                ...
                <ul class="mt-6 space-y-3 text-slate-700">
                    <li><a href="<?php echo e(route('about')); ?>" class="transition hover:text-indigo-600">About</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="transition hover:text-indigo-600">Contact</a></li>
                    <li><a href="<?php echo e(route('home')); ?>" class="transition hover:text-indigo-600">Home</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <form action="<?php echo e(route('subscribe.store')); ?>" method="POST" class="mt-6 flex flex-col gap-3 sm:flex-row">
                    <?php echo csrf_field(); ?>
        ...
        <div class="border-t border-slate-200/70 pt-6 text-center text-sm text-slate-500">
            &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Luna Boutique')); ?>. All rights reserved.
        </div>
    </div>
</footer>
<?php /**PATH C:\Projects\ecomm\resources\views/layouts/footer.blade.php ENDPATH**/ ?>