...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="space-y-8 py-10">
        <div class="space-y-3">
            ...
            <h1 class="text-4xl font-semibold tracking-tight text-slate-900">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.12)]">
                ...
                <a href="<?php echo e(route('orders.index')); ?>" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-500">View orders <span aria-hidden="true">→</span></a>
            </div>
            ...
            <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.12)]">
                ...
                <a href="<?php echo e(route('wishlist.index')); ?>" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-500">View wishlist <span aria-hidden="true">→</span></a>
            </div>
            ...
            <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.12)]">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-500">Edit profile <span aria-hidden="true">→</span></a>
            </div>
            ...
            <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.12)]">
                ...
                <a href="<?php echo e(route('return-exchanges.index')); ?>" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-500">Manage returns <span aria-hidden="true">→</span></a>
            </div>
            ...
            <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.12)]">
                ...
                <a href="<?php echo e(route('reviews.index')); ?>" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 transition hover:text-indigo-500">Manage reviews <span aria-hidden="true">→</span></a>
            </div>
        </div>
        ...
        <div class="rounded-[2rem] bg-gradient-to-br from-slate-900 to-slate-800 p-8 text-white shadow-[0_28px_80px_-40px_rgba(15,23,42,0.35)]">
            ...
            <a href="<?php echo e(route('shop.index')); ?>" class="button-primary mt-6 inline-flex bg-sky-500 hover:bg-sky-600">Browse shop</a>
        </div>
    </section>
...
<?php endif; ?><?php /**PATH C:\Projects\ecomm\resources\views/dashboard.blade.php ENDPATH**/ ?>