    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
            ...
            <div>
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" class="input-field w-full" required autofocus autocomplete="name">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" class="input-field w-full" required autocomplete="username">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('login')): ?>
                <p class="text-center text-sm text-slate-500">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="font-semibold text-indigo-600 transition hover:text-indigo-500">Sign in</a>
                </p>
...
<?php endif; ?><?php /**PATH C:\Projects\ecomm\resources\views/auth/register.blade.php ENDPATH**/ ?>